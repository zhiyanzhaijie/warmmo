...
export const CanvasHeader = memo(function CanvasHeader({ workId }: { workId: string }) {
  ...
  return (
    <header className="fixed top-space-md left-16 z-40 flex h-10 max-w-[calc(100vw_-_5rem)] items-center gap-space-sm rounded-sm border border-hairline bg-canvas-elevated/95 px-space-sm backdrop-blur-sm">

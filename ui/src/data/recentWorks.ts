...
export const recentWorks = [
  {
    ...
    previewNodes: [
      ...
      { id: 'letter', label: '匿名来信', kind: 'plot', x: 52, y: 12 },
      { id: 'chapter-1', label: '第一章', kind: 'chapter', x: 58, y: 58 },
      { id: 'harbor', label: '旧港区', kind: 'world', x: 18, y: 68 },
    ],
    previewEdges: [
  ...
  },
  {
    ...
    previewNodes: [
      ...
      { id: 'memory', label: '物品记忆', kind: 'world', x: 58, y: 15 },
      { id: 'accident', label: '被删除的事故', kind: 'plot', x: 35, y: 56 },
      { id: 'chapter', label: '失踪档案', kind: 'chapter', x: 68, y: 72 },
    ],
    previewEdges: [
  ...
  },
  {
    ...
    status: 'draft',
    previewNodes: [
      { id: 'ship', label: '鲲舟', kind: 'world', x: 12, y: 45 },
      { id: 'captain', label: '船长阿绫', kind: 'character', x: 46, y: 16 },
      { id: 'storm', label: '归墟风暴', kind: 'plot', x: 64, y: 54 },
      { id: 'ending', label: '夜航终点', kind: 'chapter', x: 28, y: 74 },
    ],
    previewEdges: [
  ...
  },
  {
    ...
    status: 'draft',
    previewNodes: [
      { id: 'city', label: '倒悬城', kind: 'world', x: 10, y: 18 },
      { id: 'architect', label: '建筑师', kind: 'character', x: 58, y: 22 },
      { id: 'gravity', label: '重力停摆', kind: 'plot', x: 35, y: 54 },
      { id: 'zero', label: '零层', kind: 'chapter', x: 64, y: 74 },
    ],
    previewEdges: [
  ...
  },
  {
    ...
    status: 'draft',
    previewNodes: [
      { id: 'tower', label: '白塔', kind: 'world', x: 16, y: 20 },
      { id: 'keeper', label: '守塔人', kind: 'character', x: 55, y: 15 },
      { id: 'bell', label: '第十三次钟声', kind: 'plot', x: 46, y: 56 },
      { id: 'opening', label: '雪夜', kind: 'chapter', x: 14, y: 72 },
    ],
    previewEdges: [

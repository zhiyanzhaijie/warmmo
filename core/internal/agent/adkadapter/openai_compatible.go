...
func (m *adkTextModel) Complete(ctx context.Context, request warmagent.ModelRequest) (string, warmagent.ModelUsage, error) {
...
func (m *adkTextModel) Stream(ctx context.Context, request warmagent.ModelRequest, onDelta func(string) error) (warmagent.ModelUsage, error) {
	...
	return warmagent.ModelUsage{}, nil
}
